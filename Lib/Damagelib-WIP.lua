...
local DamageLibTable = {
  ...
  ["Kayle"] = {
    {Slot = "Q", Stage = 1, DamageType = 2, SpellEffectType = 3, Damage = function(source, target, level) return ({60, 110, 160, 210, 260})[level] + source.TotalDmg + GetAP(source,0.6) + GetBonusAD(source) end},
